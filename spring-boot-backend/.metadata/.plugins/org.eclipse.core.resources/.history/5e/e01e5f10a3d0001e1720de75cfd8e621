...
public class AdminController {
	...
	@PutMapping("/login")
	public ResponseEntity<String> login(@RequestBody Admin admindata)
	{
		return new ResponseEntity<>(admser.login(admindata),HttpStatus.OK);
	}
	...
	public ResponseEntity<Contractor> getcontractorbyId(@PathVariable int id)
	{
	 ...
	 @PostMapping("/contractorfeedback/{id}")
