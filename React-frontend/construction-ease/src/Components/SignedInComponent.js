                  ...
                  <div className="sidebar">
                    <section className="widget">
                      ...
                      <div>
                        ...
                        <div className="widget-contact_item"><span className="widget-contacttitle">email:</span><p className="widget-contact_text"><a href="#">info@awe7.com</a></p></div>
                        <div className="widget-contact_item"><span className="widget-contacttitle">Working Hours</span><p className="widget-contact_text">Mon - Sat: 9:00 - 18:00</p></div>
                      </div>
                    </section>
                  </div>
                </div>
