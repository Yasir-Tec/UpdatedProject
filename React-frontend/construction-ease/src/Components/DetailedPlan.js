...
const toggleDescription = () => {
  ...
  return (
    <div> {projects.map((project) => (
      <section className="md-section" id="id7" style={{ backgroundColor: "#fff", padding: "220px 70 0",marginBottom: "50", marginTop:"100"}}>
        <div className="container">
        <div className="row gx-5">
  <aside className="col-lg-6">
    <div className="border rounded-4 mb-3">
      <img
        src={require(`../assets/img/service/${project.imagePath}`)} // Corrected path to the image
    ...
    <div className="d-flex align-items-center">
      ...
      <div>
        ...
        <p>Senapati Bapat road, Pune-413132</p>
                ...
                <a href="#" className="btn btn-primary shadow-0"> <i className="me-1 fa fa-shopping-basket" style={{ 
